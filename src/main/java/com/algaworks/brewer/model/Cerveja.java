...
public class Cerveja implements Serializable {
	...
	@Size(max = 50, message = "O tamanho da descrição deve ter no máximo 50 caracteres")
	...
	@Max(value = 9999, message = "A quantidade em estoque deve ser igual ou menor que 9.999")
