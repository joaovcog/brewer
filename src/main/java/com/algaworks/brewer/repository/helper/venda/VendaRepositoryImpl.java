	...
	private void adicionarFiltro(VendaFilter filtro, Criteria criteria) {
		...
		if (filtro != null) {
			...
			if (filtro.getDataCriacaoInicial() != null) {
				LocalDateTime dataInicial = LocalDateTime.of(filtro.getDataCriacaoInicial(), LocalTime.of(0, 0));
				criteria.add(Restrictions.ge("dataCriacao", dataInicial));
			}
			
			if (filtro.getDataCriacaoFinal() != null) {
				LocalDateTime dataFinal = LocalDateTime.of(filtro.getDataCriacaoFinal(), LocalTime.of(23, 59));
				criteria.add(Restrictions.le("dataCriacao", dataFinal));
			}
